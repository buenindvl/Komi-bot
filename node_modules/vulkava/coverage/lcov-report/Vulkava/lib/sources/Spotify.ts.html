...
<head>
    <title>Code coverage report for Vulkava/lib/sources/Spotify.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">Vulkava/lib/sources</a> Spotify.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">92.45% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>294/318</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>50/62</span>
            </div>
...
<a name='L318'></a><a href='#L318'>318</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span></td><td class="text"><pre class="prettyprint lang-js">import { request } from 'undici';
&nbsp;
...
&nbsp;
  constructor(vulkava: Vulkava, clientId?: string, clientSecret?: string, market = 'US') {
    super(vulkava);
&nbsp;
    if (clientId<span class="branch-0 cbranch-no" title="branch not covered" > &amp;&amp; clientSecret)</span> <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      this.auth = Buffer.from(`${clientId}:${clientSecret}`).toString('base64');</span>
    } else {
      this.auth = null;
    }
&nbsp;
...
&nbsp;
  public async loadItem(query: string): Promise&lt;SearchResult | null&gt; {
    ...
    if (!spotifyMatch || !spotifyMatch.groups) <span class="branch-0 cbranch-no" title="branch not covered" >return null;</span>
&nbsp;
...
&nbsp;
    for (const it of res.tracks.items) {
      if (it === null) <span class="branch-0 cbranch-no" title="branch not covered" >continue;</span>
&nbsp;
...
&nbsp;
      if (res instanceof SpotifyError) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        return this.handleErrorResult(res);</span>
<span class="cstat-no" title="statement not covered" >      }</span>
&nbsp;
      next = res.next !== null;
&nbsp;
...
&nbsp;
    for (const it of res.tracks.items) {
      if (it.track === null) <span class="branch-0 cbranch-no" title="branch not covered" >continue;</span>
&nbsp;
...
&nbsp;
    return {
      loadType: 'PLAYLIST_LOADED',
      playlistInfo: {
        name: `${res.tracks[0].artists.find(a =&gt; a.id === id)?.name<span class="branch-0 cbranch-no" title="branch not covered" > ?? ''}</span> Top Tracks`,
...
&nbsp;
  private async renewToken() {
    if (this.auth) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      await this.getToken();</span>
    } else {
...
&nbsp;
    if (!accessToken) <span class="branch-0 cbranch-no" title="branch not covered" >throw new Error('Failed to get anonymous token on Spotify.');</span>
&nbsp;
    this.token = `Bearer ${accessToken}`;
    this.renewDate = accessTokenExpirationTimestampMs - 5000;
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private async getToken() {</span>
<span class="cstat-no" title="statement not covered" >    const {</span>
<span class="cstat-no" title="statement not covered" >      token_type,</span>
<span class="cstat-no" title="statement not covered" >      access_token,</span>
<span class="cstat-no" title="statement not covered" >      expires_in</span>
<span class="cstat-no" title="statement not covered" >    } = await request('https://accounts.spotify.com/api/token?grant_type=client_credentials', {</span>
...
<span class="cstat-no" title="statement not covered" >        Authorization: `Basic ${this.auth}`,</span>
<span class="cstat-no" title="statement not covered" >        'Content-Type': 'application/x-www-form-urlencoded'</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }).then(r =&gt; r.body.json() as Promise&lt;IRenewResponse&gt;);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    this.token = `${token_type} ${access_token}`;</span>
<span class="cstat-no" title="statement not covered" >    this.renewDate = Date.now() + expires_in * 1000 - 5000;</span>
<span class="cstat-no" title="statement not covered" >  }</span>
}
&nbsp;
