...
<head>
    <title>Code coverage report for Vulkava/lib/sources/AppleMusic.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">Vulkava/lib/sources</a> AppleMusic.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">96.23% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>281/292</span>
            </div>
...
&nbsp;
  public async loadItem(query: string): Promise&lt;SearchResult | null&gt; {
    ...
    if (!appleMusicMatch || !appleMusicMatch.groups) <span class="branch-0 cbranch-no" title="branch not covered" >return null;</span>
&nbsp;
...
&nbsp;
      if (nextRes instanceof AppleMusicError) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        return this.handleErrorResult(nextRes);</span>
<span class="cstat-no" title="statement not covered" >      }</span>
&nbsp;
      next = nextRes.next;
&nbsp;
...
&nbsp;
    if (artistRes instanceof AppleMusicError) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      return this.handleErrorResult(artistRes);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
...
&nbsp;
    if (!tokenPayloadMatch) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Could not get Apple Music token payload!');</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
...
&nbsp;
    if (!token) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Could not get Apple Music token!');</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
    this.token = token;
...
&nbsp;
  toString(): string {
    return `AppleMusicError: ${this.detail<span class="branch-0 cbranch-no" title="branch not covered" > ?? this.title}</span>`;
  }
}
&nbsp;
